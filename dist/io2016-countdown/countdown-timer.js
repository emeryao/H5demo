...
IOWA.CountdownTimer.MOBILE_MAX_BREAKPOINT = 0;
...
IOWA.CountdownTimer.Core = function (targetDate, elem) {
    ...
    this.timeHourText = 'Hours';
    this.timeMinuteText = 'Minutes';
    this.timeSecondText = 'Seconds';
};
...
IOWA.CountdownTimer.Core.prototype.addUnits = function () {
    ...
    if (this.showCurrentTime) {
        ctx.fillText(this.timeHourText, this.bands[0].center.x + this.layout.radius + this.bandPadding / 2, this.bands[0].center.y + this.layout.radius + offset);
        ctx.fillText(this.timeMinuteText, this.bands[2].center.x + this.layout.radius + this.bandPadding / 2, this.bands[2].center.y + this.layout.radius + offset);
        ctx.fillText(this.timeSecondText, this.bands[4].center.x + this.layout.radius + this.bandPadding / 2, this.bands[4].center.y + this.layout.radius + offset);
    } else {
...
IOWA.CountdownTimer.Core.prototype.getPath = function (svgId) {
    ...
    for (var i = 0; i < quality; i++) {
        ...
        points.push({
            x: (point.x - svgHeight) / svgHeight,
            y: (point.y - svgHeight) / svgHeight
        });
    }
